...
class EmailType extends BaseType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add("constraints", new ConstraintType($aConstraints, "email", $this->attribute_id), array())
            ->add(
    ...
    public function getName()
    {
        if ($this->dynamic_name) {
            return "attribute_email_" . $this->attribute_id;
        } else {
            return "_attribute_email";
        }
    }
